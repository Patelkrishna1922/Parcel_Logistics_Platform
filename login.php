      ...
      <div class="row"style="align-items: center;">
        <div class="col-md-5">
          <div class="login-aside text-center  d-flex flex-column flex-row-auto">
            ...
            <p>Experience the Powerful Parcel Logistics Platform<br>By <a href="#">OM</a></p>
...
<div class="form-group mb-3">
  ...
  <div>
    <input type="email" class="form-control" value="" name="email" required placeholder="OMPatel@gmail.com">
...
<div class="text-center form-group mb-3">
  <button type="submit" class="btn btn-primary btn-block" onload="onPageLoad()">Sign In</button>
</div>
